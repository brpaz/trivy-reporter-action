...
| `github-token` | GitHub token with permissions to create or update issues | true    | |
...
- 🐞 **Issues**: [GitHub Issues](https://github.com/brpaz/trivy-reporter-action/issues)
- 🖇️ **Source**: [https://github.com/brpaz/trivy-reporter-action}](https://github.com/brpaz/trivy-reporter-action)
